...
# Github repo
issues_github_path = "pybfms/pybfms_riscv_debug"
...
project = u'PyBFMS RISC-V Debug'
copyright = u'2020-{0}, Matthew Ballance and Contributors'.format(datetime.datetime.now().year)
...
htmlhelp_basename = 'pybfms_riscv_debug_doc'
...
latex_documents = [
  ('index', 'pybfms_riscv_debug.tex', u'PyBFMs RISC-V Debug Documentation',
...
man_pages = [
    ('index', 'pybfms_riscv_debug', u'PyBFMs RISC-V Debug Documentation',
...
texinfo_documents = [
  ('index', 'pybfms_riscv_debug', u'PyBFMs RISC-V Debug Documentation',
   u'Matthew Ballance and Contributors', 'PyBFMs RISC-V Debug', 'Python BFMs for RISC-V Debug',
   'Miscellaneous'),
]
